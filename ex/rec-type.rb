...
Label (Lbl 3) :# "Start of def dbg_int_list"
  Store "xs"
  Intrinsic (Here ".\\ex\\rec-type.rb" (line 22, column 3))
  Load "xs"
  Dup :# "Make a copy of scrutinee for next arm"
  TestDiscr 0 :# "Discriminant for { :Nil/0 }"
...
Label (Lbl 9) :# "Next match branch"
  Dup :# "Make a copy of scrutinee for next arm"
  TestDiscr 1 :# "Discriminant for { :Cons/2 }"
...
Label (Lbl 8) :# "Match end"
  Intrinsic (Here ".\\ex\\rec-type.rb" (line 29, column 3))
...
Label (Lbl 2) :# "Start of def map"
  ...
  Const (VInt 0) :# "Discriminant for { :Nil/0 }"
  MemWriteDirect 0
...
Label (Lbl 6) :# "Next match branch"
  ...
  Const (VInt 1) :# "Discriminant for { :Cons/2 }"
  MemWriteDirect 0
  Load "x"
  Load "f"
  Call 1
